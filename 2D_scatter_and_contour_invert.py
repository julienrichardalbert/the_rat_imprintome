...
z = 'DNAme_delta_rat-mouse'
y = 'H3K27me3_delta_rat-mouse'
x = 'H3K36me3_delta_rat-mouse'
...
fig = df_subset.plot(kind="scatter", x = x, y = y, c = z, colormap="coolwarm", alpha=1, s=1, vmin=-100, vmax=100, ylim=[-3.5, 3.5], xlim=[-4,4])
